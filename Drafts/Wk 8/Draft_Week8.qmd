...
```{python}
# Compute the number of properties in each cateogry in 2025 
type_summary_2025 = (
    df_2025["room_type"]
    .value_counts()
    .to_frame("count")
...
def add_labels(x, y, pct):
    for i in range(len(x)):
        ...
        plt.text(
            ...
            bbox=dict(facecolor='#ABD7EB', alpha=0.8, edgecolor='none'))
...
#### 2.3 How many hosts own 2 or more Airbnb properties and the distribution of the number of listings per host?
