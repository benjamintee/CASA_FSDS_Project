...
-   This rises much further when we look at [frequent hosts (i.e. occupancy ≥90 days)]{.underline}. The median single-listing host earned **£`{python} f"{median_income_multi_90dmore:,.0f}"`**, while multi-listing hosts earned **`{median_income_multi_90dmore:,.0f}"`** a year per property.
...
ax.set_ylim(0, 103)
fig.suptitle(
    "Figure 2.3: Profile of Single- and Multi-listing Hosts by Country (2025)",
    fontsize=14, y=0.97)
