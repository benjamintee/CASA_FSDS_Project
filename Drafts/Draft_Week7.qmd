...
Loading the data and viewing the structure of the data and columns

```{python}
import pandas as pd

# Set filepath and read csv data using pandas
listpath_2025 = "https://orca.casa.ucl.ac.uk/~jreades/data/20250615-London-listings.csv.gz"  
df = pd.read_csv(listpath_2025, compression='gzip')
