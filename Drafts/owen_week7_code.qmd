...
print(f'Using all rental average income and mean London income \n{round(all_mean2/all_total_pro*100,2)}% of total income is made by self sustaining hosts')
print(' ')
print(f'Using all rental average income and median London income \n{round(all_median2/all_total_pro*100,2)}% of total income is made by self sustaining hosts')
print(' ')
print(f'Using frequent rental average income and mean London income \n{round(freq_mean2/freq_total_pro*100,2)}% of total income is made by self sustaining hosts')
print(' ')
print(f'Using frequent rental average income and median London income \n{round(freq_median2/freq_total_pro*100,2)}% of total income is made by self sustaining hosts')
```
...
all_mean5 = (five_list['all_by_mean'] > 5).sum()
all_median5 = (five_list['all_by_median'] > 5).sum()
freq_mean5 = (five_list['frequent_by_mean'] > 5).sum()
freq_median5 = (five_list['frequent_by_median'] > 5).sum()
