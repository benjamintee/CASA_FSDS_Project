...
```{python}
#| lst-label: Download the BibTeX file into the same folder as this qmd if it has not been downloaded yet
#| echo: false
#| warning: false
...
bib_name = "fsds_group_work.bib"

# Folder where the .qmd file lives
# This assumes you opened the folder containing the .qmd in Positron
qmd_folder = Path(".").resolve()  

# Full path for the BibTeX file
bib_path = qmd_folder / bib_name
