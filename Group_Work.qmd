...
-   The median single-listing "frequent lets" host earned **£`{python} f"{median_income_single_90dmore}"`**a year per property, while multi-listing "frequent lets" hosts earned **`{python} f"{median_income_multi_90dmore:,.0f}"`**.
