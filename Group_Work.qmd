...
cbar.set_label("Number of Listings", fontsize=13)
...
plt.ylabel(" £ per property (Last 365 days)", fontsize = 12)
...
The opposition do not explain how the council tax system might be adjusted. Notwithstanding, we note that the recent 2025 Budget outlines plans to modify the council tax system from 2028 to apply a surcharge on luxury properties, using 2026 valuations[^7]. This suggests directional flexibility in the system than historically possible, and further work to “piggyback” on these changes could be explored.
...
# Add title 
fig.suptitle("Figure 9: London's regulatory stance on short-term lets already stricter \nthan many European counterparts and this is reflected in host listings",
    x= 0.02, y = 0.96,
    fontsize=14, 
    fontweight="bold",
    ha="left")
