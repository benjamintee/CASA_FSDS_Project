...
The opposition do not explain how the council tax system might be adjusted. Notwithstanding, we note that the recent 2025 Budget outlines plans to modify the council tax system from 2028 to apply a surcharge on luxury properties, using 2026 valuations [@mcnamee2025]. This suggests greater directional flexibility in the system than historically possible, and further work to “piggyback” on these changes could be explored.
