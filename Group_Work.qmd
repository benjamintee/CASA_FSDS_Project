...
Since 2015, London landlords letting their property for more than 90 days per year must obtain planning permission for a change of use [@mayoroflondon2023-1]. The Mayor has also proposed a landlord registration system [@mayoroflondon2019] and a licensing system [@mayoroflondon2023]. Airbnb and its competitors are therefore under far more "control" in London than in many other cities.
...
To illustrate potential revenues from council tax adjustments, a **2% - 10%** **premium** was applied to the current council tax Band D rate[^8] for all properties operated by "professional" landlords.
