...
We would appreciate some comments on (1) The reproducibility of our code and whether this could be improved, and recommended coding conventions that would be helpful to produce a professional product in future, and (2) Any improvements that could be made to the way we have tangled code and prose; the large code chunks in particular, while they seem necessary, do make it difficult to focus on the flow of the narrative when putting the report together. (3) Any quick ways to check wordcount. The difficulty of confirming the wordcount of the overall document has made the drafting process slightly more complicated.
...
Studies suggest that a company or individual that operates [two or more entire homes]{.underline} can be classed as a professional landlord. Such "multi-listing hosts" could be drivers of increase in rent and of Airbnb's profit in London [@todd2021; @cox2016].
...
Note: A conservative range of 2-10% was chosen for simulation, since councils proposing a \>5% increase must hold a successful local referendum [@mhclg2025b].
